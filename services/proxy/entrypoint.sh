...
# project's own shipped default mode (bug-hunt #849, finding N4). Emitting
...
#     listeners (bug-hunt #849, finding N1)
#
...
if [ "${SSL_ENABLED}" = "1" ]; then
...

    {
        ...
        echo "    listen 443;"
        echo "    listen [::]:443;"
        # Client-IP allowlist (finding N1, see "2b." above) -- this is the
