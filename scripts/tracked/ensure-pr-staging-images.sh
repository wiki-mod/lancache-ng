...
# scripts/tracked/simulations/syslog-forwarding-simulation.sh's Triggers 7/8 (real DHCP lease
...
# for): now included too. scripts/tracked/simulations/syslog-forwarding-simulation.sh starts it
...
# scripts/tracked/simulations/syslog-forwarding-simulation.sh already pulls/starts/health-waits on
...
# Maps this file's own matrix-service names to scripts/tracked/classify-image-impact.sh's
