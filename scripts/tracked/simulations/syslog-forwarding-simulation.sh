...
# project's CI (scripts/untracked/check-logging-matrix.sh, `docker compose config`)
...
# the same risk scripts/tracked/simulations/dhcp-kea-lease-flow-simulation.sh and
# scripts/tracked/simulations/dhcp-proxy-pxe-simulation.sh already avoid by using their own
...
# logging wiring instead of the real thing scripts/untracked/check-logging-matrix.sh
...
# and is the same compose file scripts/tracked/simulations/setup-cli-simulation.sh already
