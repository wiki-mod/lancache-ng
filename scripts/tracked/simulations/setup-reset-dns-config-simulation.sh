...
# scripts/tracked/simulations/setup-reset-kea-config-simulation.sh's rigor for the Kea target and
# reuses scripts/tracked/simulations/dns-zone-rollback-simulation.sh's proven stack/UI-mutation
