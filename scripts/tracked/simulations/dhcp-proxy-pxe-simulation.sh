...
# scripts/tracked/simulations/dhcp-kea-lease-flow-simulation.sh's own header comment
...
#
# Safety model, mirroring scripts/tracked/simulations/dhcp-kea-lease-flow-simulation.sh's own
