...
# scripts/tracked/simulations/dhcp-kea-lease-flow-simulation.sh -- see docs/dhcp-modes.md). That
...
#      project/network/fixed-IP pattern scripts/tracked/simulations/ui-nats-dns-integration-simulation.sh
