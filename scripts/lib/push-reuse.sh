...
# contains their own build/push/scan steps. Real volume this addresses:
# build-tools saw 30 rebuilds in 5 days (~2700 GHCR versions) from
# workflow-only diffs before this narrowing existed.
#
