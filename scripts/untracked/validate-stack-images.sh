...
# #871 (cachehamster) is the newest addition and is likewise carried here.
...
# file's own comment near the CI_BUILD_SERVICES check above; #871 added
# cachehamster, the newest first-party service).
