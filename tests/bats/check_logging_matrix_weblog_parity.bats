...
# scripts/check-logging-matrix.sh: deploy/quickstart/docker-compose.yml
...
#
# scripts/check-logging-matrix.sh's earlier matrix-row section needs a real
...
# duplicate scripts/check-compose-healthchecks.sh's own service-block
