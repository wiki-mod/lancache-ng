...
# ngx_stream_access_module allow/deny generator added to close bug-hunt
# #849's finding N1: the stream-level externally-facing listeners (standard
# mode's 8443, SSL mode's 443 dispatcher) had zero client-IP enforcement
# regardless of PROXY_ALLOWED_CLIENT_CIDRS.
