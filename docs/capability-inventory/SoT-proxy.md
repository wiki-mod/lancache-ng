...
- `PROXY_SECURITY_MODE=strict` and `PROXY_ALLOWED_CLIENT_CIDRS` (403 paths)
  ...
  row) is real-verified by `scripts/proxy-ssl-mode-two-relay-dispatch-simulation.sh`
